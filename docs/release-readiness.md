...
- Separate installation-operator and application-user sessions, one installation
...
- Operator account profile, footer logout, email code/link and optional Argon2id
...
- Application and workspace roles, permission checks/explanations, workspace invitations,
...
- Complete granular operator permissions beyond owner/admin/auditor/member roles.
