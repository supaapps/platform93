...
Expires at: {{expires_at}}.','<h1>Your Platform93 invitation</h1><p>You were invited as <strong>{{role}}</strong>.</p><p>Onboarding method: {{onboarding_method}}</p><p><a href="{{invitation_link}}">Accept invitation</a></p><p>Expires at {{expires_at}}.</p>','{"required": ["role", "onboarding_method", "invitation_link", "expires_at"], "properties": {"role": {"type": "string"}, "onboarding_method": {"type": "string"}, "invitation_link": {"type": "string"}, "invitation_token": {"type": "string"}, "expires_at": {"type": "string"}}}'::jsonb,'published',true),
...
Expires at: {{expires_at}}.','<h1>Invitation to {{application_name}}</h1><p><strong>Code:</strong> {{invitation_code}}</p><p><a href="{{invitation_link}}">Accept invitation</a></p><p>Roles: {{role_keys}}<br>Expires at {{expires_at}}.</p>','{"required": ["invitation_code", "invitation_link", "role_keys", "expires_at"], "properties": {"role_keys": {"type": "string"}, "expires_at": {"type": "string"}, "inviter_name": {"type": "string"}, "invitation_code": {"type": "string"}, "invitation_link": {"type": "string"}}}'::jsonb,'published',true),
...
This credential expires in {{expires_minutes}} minutes. If you did not request it, ignore this message.','<h1>Sign in to {{application_name}}</h1><p>Use the code or secure link below.</p><p><strong>Code:</strong> {{code}}</p><p><a href="{{magic_link}}">Continue signing in</a></p><p>This credential expires in {{expires_minutes}} minutes. If you did not request it, ignore this message.</p>','{"required": ["code", "magic_link", "expires_minutes", "intent"], "properties": {"code": {"type": "string", "title": "Sign-in code", "example": "AB12CD34"}, "intent": {"type": "string", "title": "Authentication intent", "example": "sign_in"}, "magic_link": {"type": "string", "title": "Magic link", "example": "https://app.example/auth/callback"}, "expires_minutes": {"type": "integer", "title": "Expiry in minutes", "example": 10}}}'::jsonb,'published',true),
...
This credential expires in {{expires_minutes}} minutes.','<h1>Confirm your new email</h1><p>Confirm this email address for {{application_name}}.</p><p><strong>Code:</strong> {{code}}</p><p><a href="{{magic_link}}">Confirm email</a></p><p>This credential expires in {{expires_minutes}} minutes.</p>','{"required": ["code", "magic_link", "expires_minutes"], "properties": {"code": {"type": "string", "title": "Confirmation code", "example": "AB12CD34"}, "magic_link": {"type": "string", "title": "Confirmation link", "example": "https://app.example/auth/callback"}, "expires_minutes": {"type": "integer", "title": "Expiry in minutes", "example": 10}}}'::jsonb,'published',true),
...
This credential expires in {{expires_minutes}} minutes. If you did not request it, ignore this message.','<h1>Sign in to Platform93</h1><p>A sign-in was requested for your Platform user account.</p><p><strong>Code:</strong> {{code}}</p><p><a href="{{magic_link}}">Sign in securely</a></p><p>This credential expires in {{expires_minutes}} minutes. If you did not request it, ignore this message.</p>','{"required": ["code", "magic_link", "expires_minutes"], "properties": {"code": {"type": "string", "title": "Sign-in code", "example": "AB12CD34"}, "magic_link": {"type": "string", "title": "Magic link", "example": "https://platform93.example/?control_user_challenge=true"}, "expires_minutes": {"type": "integer", "title": "Expiry in minutes", "example": 10}}}'::jsonb,'published',true),
...
If you did not expect this invitation, ignore this message.','<h1>Organization invitation</h1><p>You were invited to administer <strong>{{organization_name}}</strong> as {{role}}.</p><p><a href="{{invitation_link}}">Accept invitation</a></p><p><strong>One-time invitation code:</strong> {{invitation_token}}</p><p>Expires at {{expires_at}}.</p>','{"required": ["organization_name", "role", "invitation_link", "invitation_token", "expires_at"], "properties": {"role": {"type": "string", "title": "Organization role", "example": "admin"}, "expires_at": {"type": "string", "title": "Expiry time", "example": "2026-08-15T12:00:00Z"}, "invitation_link": {"type": "string", "title": "Invitation link", "example": "https://platform93.example/?organization_invitation=true"}, "invitation_token": {"type": "string", "title": "One-time invitation code", "example": "p93_org_invite_example"}, "organization_name": {"type": "string", "title": "Organization name", "example": "Acme GmbH"}}}'::jsonb,'published',true),
...
This credential expires in {{expires_minutes}} minutes. If you did not request it, ignore this message.','<h1>Reset your password</h1><p>A password reset was requested for {{application_name}}.</p><p><strong>Code:</strong> {{code}}</p><p><a href="{{magic_link}}">Reset password</a></p><p>This credential expires in {{expires_minutes}} minutes. If you did not request it, ignore this message.</p>','{"required": ["code", "magic_link", "expires_minutes"], "properties": {"code": {"type": "string", "title": "Reset code", "example": "AB12CD34"}, "magic_link": {"type": "string", "title": "Reset link", "example": "https://app.example/auth/callback"}, "expires_minutes": {"type": "integer", "title": "Expiry in minutes", "example": 10}}}'::jsonb,'published',true),
...
This credential expires in {{expires_minutes}} minutes.','<h1>Verify your email</h1><p>Confirm your email address for {{application_name}}.</p><p><strong>Code:</strong> {{code}}</p><p><a href="{{magic_link}}">Verify email</a></p><p>This credential expires in {{expires_minutes}} minutes.</p>','{"required": ["code", "magic_link", "expires_minutes"], "properties": {"code": {"type": "string", "title": "Verification code", "example": "AB12CD34"}, "magic_link": {"type": "string", "title": "Verification link", "example": "https://app.example/auth/callback"}, "expires_minutes": {"type": "integer", "title": "Expiry in minutes", "example": 10}}}'::jsonb,'published',true),
...
Expires at: {{expires_at}}.','<h1>Workspace invitation</h1><p>You were invited to join <strong>{{workspace_name}}</strong> in {{application_name}}.</p><p><strong>Code:</strong> {{invitation_code}}</p><p><a href="{{invitation_link}}">Accept invitation</a></p><p>Roles: {{role_keys}}<br>Expires at {{expires_at}}.</p>','{"required": ["workspace_id", "workspace_name", "role_keys", "invitation_code", "invitation_link", "expires_at"], "properties": {"role_keys": {"type": "string"}, "expires_at": {"type": "string"}, "inviter_name": {"type": "string"}, "workspace_id": {"type": "string"}, "workspace_name": {"type": "string"}, "invitation_code": {"type": "string"}, "invitation_link": {"type": "string"}}}'::jsonb,'published',true);
-- +goose StatementEnd
